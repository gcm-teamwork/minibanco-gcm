...
public class AccountController {
    ...
    public String createAccount(String number, double balance, int typeAccount) {
        boolean createWithSucces = service.createAccount(number, balance, getTypeAccount(typeAccount));
        if (createWithSucces) {
